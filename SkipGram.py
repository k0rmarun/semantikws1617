...
from BiSkip import BiSkip
from PrepareBiSkip import prepare_biskip
...
#     return generate_batch(batch_size, num_skips, skip_window)
...
if __name__ == '__main__':
    ...
    dictionary, reverse_dictionary, batch = prepare_biskip(batch_splitter)
    print("created dictionary")

    bs = BiSkip(dictionary, reverse_dictionary, valid_examples)
    bs.train(batch)
    print("Similar to \"one\":", bs.predict_one("one", k=5))
    print("Similar to [\"one\",\"two\",\"six\",\"eight\"]",bs.predict_context(["one","two","six","eight"]))